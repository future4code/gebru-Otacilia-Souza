...
//  O parametro passado foi o query para pequisar se tinha normal ou admin.

//     b- Você consegue pensar em um jeito de garantir que apenas `types` válidos sejam utilizados?

// Usando um try e catch alem de um if comprando as entrada com a string .toLowerCase() . 
